...
private constructor() {
    ...
    (context: Context?, private val mDetector: Detector<*>?) {
        ...
        init {
            kotlin.requireNotNull(context) { "No context supplied." }
            kotlin.requireNotNull(mDetector) { "No detector supplied." }
        ...
        fun setRequestedFps(fps: Float): Builder {
            kotlin.require(fps > 0) { "Invalid fps: $fps" }
        ...
        fun setRequestedPreviewSize(width: Int, height: Int): Builder {
            ...
            val MAX = 1000000
            kotlin.require(!(width <= 0 || width > MAX || height <= 0 || height > MAX)) { "Invalid preview size: " + width + "x" + height }
        ...
        fun setFacing(facing: Int): Builder {
            kotlin.require(!(facing != CAMERA_FACING_BACK && facing != CAMERA_FACING_FRONT)) { "Invalid camera: $facing" }
    ...
    private fun createPreviewBuffer(previewSize: Size): ByteArray {
        ...
        kotlin.check(!(!buffer.hasArray() || buffer.array() != byteArray)) { // I don't think that this will ever happen.  But if it does, then we wouldn't be
